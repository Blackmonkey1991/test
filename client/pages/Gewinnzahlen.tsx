            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  <strong>{t('winningNumbers.fridayTime')}</strong>
                </p>
                <Badge
                  variant="outline"
                        ...
                        <div className="flex flex-col items-start space-y-2">
                          ...
                          <div className="flex space-x-1">
                            {ticket.mainNumbers.map((number, index) => {
                              const isMatch = latestCompletedDrawing && latestCompletedDrawing.mainNumbers.includes(number);
                              return (
                                <div
                                  key={index}
                        ...
                        <div className="flex flex-col items-start space-y-2">
                          ...
                          <div className="flex space-x-1">
                            {ticket.worldNumbers.map((number, index) => {
                              const isMatch = latestCompletedDrawing && latestCompletedDrawing.worldNumbers.includes(number);
                              return (
                                <div
                                  key={index}
                                  className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold border transition-all duration-300 ${
